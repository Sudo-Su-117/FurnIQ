...
export default function DashboardPage() {
  ...
  const kpiCards = [
    { label: 'Total Sales',       sublabel: 'Sep 2026',          value: '₹3.58L', note: 'Total Sales',       color: 'kpi-default', icon: 'sales'      },
    { label: 'Total Purchased',   sublabel: 'Sep 2026',          value: '₹2.34L', note: 'Total Purchases',   color: 'kpi-default', icon: 'purchase'   },
    { label: 'Cash & Bank',       sublabel: 'Combined balance',  value: '₹4.95L', note: 'Available liquidity',color: 'kpi-default', icon: 'cash'       },
    { label: 'Receivables',       sublabel: 'Outstanding invoices',value: '₹3.10L',note: 'From customers',   color: 'kpi-default', icon: 'receivable' },
    { label: 'Payables',          sublabel: 'Outstanding bills', value: '₹82k',   note: 'To vendors',        color: 'kpi-default', icon: 'payable'    },
    { label: 'Low Stock Products',sublabel: 'Below threshold',   value: '3',      note: 'Manage Products',   color: 'kpi-alert',   icon: 'alert'      },
  ]
      ...
      <div className="db-page">
        ...
        <header className="db-header">
          <div className="db-header-left">
            <h1 className="db-greeting">Good morning, Vikram.</h1>
            <p className="db-subline">FurnIQ · Mumbai · September 2026</p>
          </div>

          {/* Tab menu bar */}
          <div className="db-tab-bar">
            {Object.keys(MENU_TABS).map(tab => (
              <div key={tab} className="db-tab-wrapper">
                <button
                ...
                {activeTab === tab && (
                  <div className="db-dropdown">
                    {MENU_TABS[tab].map(item => (
                      <button key={item} className="db-dropdown-item"
        ...
        <div className="db-content" onClick={() => activeTab && setActiveTab(null)}>
          {/* ---- KPI Cards ---- */}
